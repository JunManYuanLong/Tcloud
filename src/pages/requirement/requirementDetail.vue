    ...
    <div :class="wrapClasses" @click="handleWrapClick">
      <transition name="moveRight">
        <div class="drawer-right" :style="drawerStyle" v-show="visible">
          <div class="drawer-content requirement-detail-content" v-loading="loading">
            <div class="require-detail-wrap" @click="closeComment">
              <div class="button-bar"><!-- <el-button @click="handleClose">取消</el-button> -->
    ...
    watch: {
      ...
      'value': {
        handler: function (val) {
          ...
          if(val){
            ...
            requirementApi.getDetailById(this.requireData.id).then((res) => {
              if (res.data.code === 0) {
                this.getEditData(res.data.data[0])
                this.loading = false
                //检测首次富文本框内容是否发生变化
                setTimeout(()=>{
      ...
      'editData': {
        handler: function (val) {
          ...
          console.log('editDatachange',val,'-',this.changeCount)
        },
        deep: true
      },
      'editData.description':{
        handler: function (val) {
          ...
          console.log('description',val,'-',this.changeCount)
        },
        deep: true
      },
      'uploadFile': {
    ...
    methods: {
      ...
      getEditData(detailData) {
        ...
        this.editData = {
          ...
          worth_sure : detailData.worth_sure?detailData.worth_sure:'',
        ...
        console.log('changecoutn--init',this.changeCount)
      },
      getRequireLog() {
