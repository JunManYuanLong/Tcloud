        ...
        <div class="detail-content">
            <el-tabs v-model="activeName" style="width: 100%;">
                ...
                <el-tab-pane name="second" class="detail-content-panel">
                    <span slot="label"><i class="el-icon-goods"></i> 测试详情</span>
                    <TestDetailSub :sub-data="detailData"></TestDetailSub>    
                </el-tab-pane>
                <el-tab-pane name="third" class="detail-content-panel">
                    <span slot="label"><i class="el-icon-edit-outline"></i> 日志记录</span>
                    <ErrorLog :sub-data="detailData"></ErrorLog>    
                </el-tab-pane>
            </el-tabs>
        </div>
    </div>    
...
import TestDetailSub from './detailComp/TestDetailSub'
import ErrorLog from './detailComp/ErrorLog'
export default {
    data () {
        return {
            activeName: 'first',
