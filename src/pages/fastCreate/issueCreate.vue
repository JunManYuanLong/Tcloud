        ...
        >
          ...
          <el-form-item label="出现机率：" prop="chance">
            <el-select v-model="addData.chance" placeholder="请选择" clearable>
              <el-option
                v-for="(val,key) in issueSet.chance"
                :key="key"
                :label="val"
                :value="parseInt(key)"
              ></el-option>
          ...
          <el-form-item label="所属系统：" prop="system">
            <el-select v-model="addData.system" placeholder="请选择" clearable>
              <el-option
                v-for="(val,key) in issueSet.systems"
                :key="key"
                :label="val"
                :value="parseInt(key)"
              ></el-option>
          ...
          <el-form-item label="用户识别度：" prop="detection_chance">
            <el-select v-model="addData.detection_chance" placeholder="请选择" clearable>
              <el-option
                v-for="(val,key) in issueSet.detection_chance"
                :key="key"
                :label="val"
                :value="parseInt(key)"
              ></el-option>
  ...
  data() {
    return {
      ...
      rules: {
        ...
        version: [
          { required: true, message: "请选择选择缺陷版本", trigger: "change" }
        ]
